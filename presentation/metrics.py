...
METRIC_SPECS: list[MetricSpec] = [
    ...
    MetricSpec("Gross Margin", "매출총이익률", MetricFormat.FRACTION_PERCENT, MetricGroup.PROFITABILITY),
    MetricSpec("Operating Margin", "영업이익률", MetricFormat.FRACTION_PERCENT, MetricGroup.PROFITABILITY),
    MetricSpec("Net Margin", "순이익률", MetricFormat.FRACTION_PERCENT, MetricGroup.PROFITABILITY),
    MetricSpec("Asset Turnover", "자산회전율", MetricFormat.MULTIPLE, MetricGroup.PROFITABILITY),
    MetricSpec("Inventory Turnover", "재고자산회전율", MetricFormat.MULTIPLE, MetricGroup.PROFITABILITY),
    MetricSpec("Receivables Turnover", "매출채권회전율", MetricFormat.MULTIPLE, MetricGroup.PROFITABILITY),
    MetricSpec("Effective Tax Rate", "유효법인세율", MetricFormat.FRACTION_PERCENT, MetricGroup.PROFITABILITY),
    ...
    MetricSpec("Quick Ratio", "당좌비율", MetricFormat.MULTIPLE, MetricGroup.STABILITY),
    MetricSpec("Cash Ratio", "현금비율", MetricFormat.MULTIPLE, MetricGroup.STABILITY),
    MetricSpec("Interest Ratio", "이자보상배율", MetricFormat.MULTIPLE, MetricGroup.STABILITY),
    MetricSpec("Capex to Revenue", "설비투자/매출 비율", MetricFormat.FRACTION_PERCENT, MetricGroup.STABILITY),
    ...
    MetricSpec("12-1Y Ratio", "12-1 모멘텀 (최근 1개월 제외)", MetricFormat.PERCENT, MetricGroup.MOMENTUM),
    ...
    # --- QIP3 5요인 점수 (analysis/qip3_*가 계산, QUANT2.md 참고) ---
    MetricSpec("QIP3 Score", "QIP3 종합 점수", MetricFormat.SCORE, MetricGroup.SCORES),
    MetricSpec("QIP3 ScoreSec", "QIP3 종합 점수 (섹터 내)", MetricFormat.SCORE, MetricGroup.SCORES),
    MetricSpec("QIP3 Value", "QIP3 가치성", MetricFormat.SCORE, MetricGroup.SCORES),
    MetricSpec("QIP3 Growth", "QIP3 성장성", MetricFormat.SCORE, MetricGroup.SCORES),
    MetricSpec("QIP3 Momentum", "QIP3 모멘텀", MetricFormat.SCORE, MetricGroup.SCORES),
