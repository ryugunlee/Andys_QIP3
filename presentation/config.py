...
QIP3_DISPLAY_LIMIT: int = 12  # 주식 분석 페이지의 QIP3 5요인 선별 종목 카드
QIP3_CONCENTRATION_TOP_N: int = 6  # 선별 결과 섹터/시장 쏠림에서 보여줄 상위 항목 수
QIP4_DISPLAY_LIMIT: int = 12  # 주식 분석 페이지의 QIP4 선별 종목 카드
